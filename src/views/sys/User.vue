<template>
  <div>
    ...
    <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" border stripe
      ...
      <el-table-column prop="code" label="角色名称"  width="200" align="center">
...
<!--      <el-table-column prop="mobile" label="手机号" align="center"></el-table-column>-->
      <el-table-column prop="statu" label="状态" width="180" align="center">
        <template slot-scope="scope">
          <el-tag size="small" v-if="scope.row.statu === 1" type="success">正常</el-tag>
          <el-tag size="small" v-else-if="scope.row.statu === 0" type="danger">禁用</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="created" width="300" label="创建时间" align="center"></el-table-column>
    ...
    <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" layout="total, sizes, prev, pager, next, jumper"
      :page-sizes="[10, 20, 50, 100]" :current-page="current" :page-size="size" :total="total">
    </el-pagination>
    <!--新增对话框-->
